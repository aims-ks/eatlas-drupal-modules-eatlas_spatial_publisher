...
// TODO Document content-change event on '.eatlas_spatial_publisher_map .map_panel'
//   state can be:
    ...
    for (var i=0; i<this.config.layers.length; i++) {
        ...
        function styleFunction(layerConfig, that) {
            ...
            return function(feature, resolution) {
                ...
                if (feature.getId() === that.selectedFeatureId || (feature.get('_parent_id') && feature.get('_parent_id') === that.selectedFeatureId)) {
...
EAtlasSpatialPublisherMap.prototype.setPanelTitle = function(title) {
    document.title = title;
};

EAtlasSpatialPublisherMap.prototype.loadPanelTitle = function(titleUrl) {
    if (titleUrl) {
        jQuery.get(titleUrl,
